 ...
 */
final class Version20240623122957 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE SEQUENCE notify_message_user_id_seq INCREMENT BY 1 MINVALUE 1 START 1');
        $this->addSql('CREATE TABLE notify_message_user (id INT NOT NULL, owner_id INT NOT NULL, notify_message_id UUID NOT NULL, sent BOOLEAN NOT NULL, status VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id))');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP SEQUENCE notify_message_user_id_seq CASCADE');
